...
<?php
        ...
        fana_tbay_render_breadcrumbs();

        $class_main = apply_filters('fana_tbay_post_content_class', 'container');
	...
	<section id="main-container" class="main-content  <?php echo esc_attr($class_main); ?>">
		...
		<?php do_action('fana_post_template_main_container_before'); ?>
		...
		<div class="row <?php echo esc_attr($class_row); ?>">
			...
			<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
				<div id="main" class="site-main layout-blog">
					...
					<?php do_action('fana_post_template_main_content_before'); ?>

					<div class="row grid" <?php echo wc_trim_string($data_responsive); ?>>
						<?php if (have_posts()) : ?>
					...
					<?php do_action('fana_post_template_main_content_after'); ?>
		...
		<?php do_action('fana_post_template_main_container_after'); ?>
	</section> 
	<?php
    }
