<?php
    ...
    $mmenu_langue           = fana_tbay_get_config('enable_mmenu_langue', false);
    $mmenu_currency         = fana_tbay_get_config('enable_mmenu_currency', false);

    $menu_mobile_select    =  fana_tbay_get_config('menu_mobile_select');
?>
  
<div id="tbay-mobile-smartmenu" data-title="<?php esc_attr_e('Menu', 'fana'); ?>" class="tbay-mmenu d-xl-none"> 
    ...
    <div class="tbay-offcanvas-body">
        ...
        if ( empty($menu_mobile_select) ) {
            if( !empty($theme_locations) ) {
                ...
                $menu_name = fana_get_transliterate($menu_obj->name);
            } else {
                $menu_name = '';
            }
            ...
            $menu_name = fana_get_transliterate($menu_obj->slug);
        }
        ?>
        <nav id="tbay-mobile-menu-navbar" class="menu navbar navbar-offcanvas navbar-static" data-id="menu-<?php echo esc_attr($menu_name); ?>" >
            <?php
                ...
                if( class_exists('Fana_Megamenu_Walker') ) {
                    $args['walker']             =   new Fana_Megamenu_Walker();
                } else { 
                    ...
                    <div class="mm-bottom-langue-currency ">
                        <?php if ($mmenu_langue): ?>
                            <div class="mm-bottom-langue">
                                <?php do_action('fana_tbay_header_custom_language'); ?>
                            </div>
                        <?php endif; ?>
