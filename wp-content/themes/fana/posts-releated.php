<?php
    ...
    $relate_count = fana_tbay_get_config('number_blog_releated', 2);
    $relate_columns = fana_tbay_get_config('releated_blog_columns', 2);
...
?>
    <div class="tbay-addon tbay-addon-blog relate-blog">
        <h4 class="tbay-addon-title">
            <span><?php esc_html_e('Related posts', 'fana'); ?></span>
        </h4>
        ...
        <div class="tbay-addon-content">
            ...
            <?php
                ...
                $navleft    = apply_filters('fana_slick_prev', '<i class="tb-icon tb-icon-angle-left"></i>');
                $navright   = apply_filters('fana_slick_next', '<i class="tb-icon tb-icon-angle-right"></i>');
