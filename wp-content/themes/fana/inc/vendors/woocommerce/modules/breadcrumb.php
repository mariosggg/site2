...
if (!function_exists('fana_tbay_woocommerce_breadcrumb_defaults')) {
    function fana_tbay_woocommerce_breadcrumb_defaults($args)
    {
        ...
        if( is_product() ) {
            $breadcrumb_img = fana_tbay_get_config('woo_single_breadcrumb_image');
            $breadcrumb_color = fana_tbay_get_config('woo_single_breadcrumb_color');
            $breadcrumbs_layout = fana_tbay_get_config('single_product_breadcrumb_layout', 'color');
        } else {
            $breadcrumb_img = fana_tbay_get_config('woo_breadcrumb_image');
            $breadcrumb_color = fana_tbay_get_config('woo_breadcrumb_color');
            $breadcrumbs_layout = fana_tbay_get_config('product_breadcrumb_layout', 'color');
        }
        ...
        if (isset($breadcrumb_img['url']) && !empty($breadcrumb_img['url']) && $breadcrumbs_layout !=='color' && $breadcrumbs_layout !=='text') {
            $img = '<img src="'.esc_url($breadcrumb_img['url']).'" alt="'.esc_attr__('breadcrumb-img','fana') .'" >';
        }
