...
if (! function_exists('fana_has_swatch')) {
    function fana_has_swatch($id, $attr_name, $value)
    {
        $swatches = array();
...
if (! function_exists('fana_get_option_variations')) {
    function fana_get_option_variations($attribute_name, $available_variations, $option = false, $product_id = false)
    {
        ...
        foreach ($available_variations as $key => $variation) {
            ...
            if ($option) {
                ...
                $swatch = fana_has_swatch($product_id, $attribute_name, $val);
 ...
 * ------------------------------------------------------------------------------------------------
 */
if (! function_exists('fana_swatches_list')) {
    function fana_swatches_list($attribute_name = false)
    {
        global $product;
        ...
        if (! $attribute_name) {
            $attribute_name = fana_get_swatches_attribute();
        }
        ...
        $swatches_to_show = fana_get_option_variations($attribute_name, $available_variations, false, $id);
...
if (! function_exists('fana_get_swatches_attribute')) {
    function fana_get_swatches_attribute()
    {
        $custom = get_post_meta(get_the_ID(), '_fana_attribute_select', true);

        return empty($custom) ? fana_tbay_get_config('variation_swatch') : $custom;
    }
}