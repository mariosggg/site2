...
if (! class_exists('Fana_Single_WooCommerce')) :


    class Fana_Single_WooCommerce
    {
        ...
        {
            if (! isset(self::$instance) && ! (self::$instance instanceof Fana_Single_WooCommerce)) {
                self::$instance = new Fana_Single_WooCommerce();
            }
        ...
        public function __construct()
        {
            ...
            add_action('fana_woocommerce_single_product_summary_right', array( $this, 'share_box_html'), 30);
            ...
            add_filter('fana_woo_tabs_style_single_product', array( $this, 'get_tabs_style_product'), 10, 1);
            ...
            if (!wp_is_mobile()) {
                ...
                add_action('fana_sticky_menu_bar_product_summary', 'fana_woocommerce_single_title', 5);
                add_action('fana_sticky_menu_bar_product_summary', 'woocommerce_template_single_rating', 10);
                add_action('fana_sticky_menu_bar_product_summary', array( $this, 'the_product_single_one_page'), 15);


                add_action('fana_sticky_menu_bar_product_price_cart', 'woocommerce_template_single_price', 5);
                add_action('fana_sticky_menu_bar_product_price_cart', array( $this, 'the_sticky_menu_bar_custom_add_to_cart'), 10);
            }
            ...
            add_action('fana_woocommerce_before_product_thumbnails', array($this,'get_video_audio_content_first'), 10, 2);
        ...
        public function add_custom_product_tabs($tabs)
        {
            ...
            $tab_content    = maybe_unserialize(get_post_meta($product_id, '_fana_custom_tab_content', true));
            $name           = maybe_unserialize(get_post_meta($product_id, '_fana_custom_tab_name', true));
            $priority       = (int) maybe_unserialize(get_post_meta($product_id, '_fana_custom_tab_priority', true));
        ...
        public function setup_support()
        {
            ...
            add_image_size('fana_photo_reviews_thumbnail_image', $ptreviews['width'], $ptreviews['height'], $ptreviews['crop']);
        }
        ...
        {
            $thumbnail_cropping    	= get_option('fana_photo_reviews_thumbnail_image_cropping', 'yes');
            $cropping    			= ($thumbnail_cropping == 'yes') ? true : false;

            return array(
                'width'  => get_option('fana_photo_reviews_thumbnail_image_width', 100),
                'height' => get_option('fana_photo_reviews_thumbnail_image_height', 133),
                'crop'   => $cropping,
            );
        }
        ...
        public function product_group_buttons()
        {
            ...
            <div class="group-button">
                ...
                <div class="tbay-wishlist">
                    <?php fana_the_yith_wishlist(); ?>
                </div>
                <?php } ?>
                <?php if (class_exists('YITH_Woocompare')) { ?>
                <div class="tbay-compare">
                    <?php fana_the_yith_compare($product_id); ?>
                </div>
                <?php } ?>
            </div>
            <?php } ?>
        ...
        public function buy_now_html()
        {
            ...
            global $product;
            if (! intval(fana_tbay_get_config('enable_buy_now', true))) {
                return;
            }
            ...
            echo '<button class="'. esc_attr($class) .'">'. esc_html__('Buy Now', 'fana') .'</button>';
            echo '<input type="hidden" value="0" name="fana_buy_now" />';
        }

        public function buy_now_redirect($url)
        {
            if (! isset($_REQUEST['fana_buy_now']) || $_REQUEST['fana_buy_now'] == false) {
                return $url;
            }
            ...
            $redirect = fana_tbay_get_config('redirect_buy_now', 'cart') ;
        ...
        public function the_list_images_review()
        {
            ...
            if (is_array($comments) || is_object($comments)) {
                ...
                $outputs .= '</ul>';
                $outputs .= '<a  data-bs-toggle="collapse" href="#imageReview" class="toogle-img-review"> '. $i. esc_html__(' Images from customers', 'fana') .'</a>';
                $outputs .= '</div>';
            }
        ...
        {
            if( !fana_tbay_get_config('enable_code_share',false) || !fana_tbay_get_config('enable_product_social_share', false) ) return;
        ...
        public function class_body_single_product( $classes ) {
            ...
            $cart_style = fana_get_mobile_form_cart_style();
        ...
        public function get_tabs_style_product($tabs_layout)
        {
            if (is_singular('product')) {
                $tabs_style       = fana_tbay_get_config('style_single_tabs_style', 'tabs');
        ...
        public function the_product_single_time_countdown()
        {
            ...
            $style_countdown   = fana_tbay_get_config('enable_product_countdown', false);
            ...
            <div class="tbay-time-wrapper">
                <div
                    class="time tbay-time <?php echo ( fana_tbay_get_config('enable_text_time_coutdown', false) ) ? 'label-coutdown' : '';?>">
                    <div class="times-countdown">
                        <div class="title-end-times">
                            <h3 class="title"><?php esc_html_e('HUNGRY UP !', 'fana'); ?></h3>
                            <span><?php esc_html_e('Deal end in: ', 'fana'); ?></span>
                        </div>
        ...
        public function the_sticky_menu_bar()
        {
            ...
            $menu_bar   =  apply_filters('fana_woo_product_menu_bar', 10, 2);
                        ...
                        <div class="menu-bar-left col-lg-7">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <?php
                                        do_action('fana_sticky_menu_bar_product_summary'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="menu-bar-right product col-lg-5">
                            <?php
                                    do_action('fana_sticky_menu_bar_product_price_cart'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        public function the_sticky_menu_bar_custom_add_to_cart()
        {
            ...
            if (!$product->is_in_stock()) {
                ...
                <a id="sticky-custom-add-to-cart"
                    href="javascript:void(0);"><?php echo esc_html($product->single_add_to_cart_text()); ?></a>
                <?php
            }
        }
        ...
        public function before_add_to_cart_form()
        {
            ...
            if (intval(fana_tbay_get_config('enable_buy_now', true)) && $product->get_type() !== 'external') {
                $class .= ' has-buy-now';
            }

            if( fana_tbay_get_config('enable_ajax_single_add_to_cart', false) ) {
        ...
        {
            $args['posts_per_page'] = fana_tbay_get_config('number_product_releated', 5); // 4 related products
        ...
        {
            $thumbnail_id = $product->get_meta('_fana_video_image_url');
            return $thumbnail_id;
        }
        ...
        {
            $video_url  = $product->get_meta('_fana_video_url');
            $video_args = array();

            if (! empty($video_url)) {
                list($host, $video_id) = explode(':', fana_video_type_by_url($video_url));
        ...
        {
            if (fana_tbay_get_config('video_position', 'last') === 'first') {
                return;
            }
        ...
        {
            if (fana_tbay_get_config('video_position', 'last') === 'last') {
                return;
            }
        ...
        {
            if (!fana_tbay_get_config('enable_product_review_tab', true) && isset($tabs['reviews'])) {
                unset($tabs['reviews']);
            }
            return $tabs;
        }
        ...
        {
            $active = fana_tbay_get_config('enable_zoom_image', true);
        ...
        {
            $img_src     = wp_get_attachment_image_src($image_post_id, 'fana_photo_reviews_thumbnail_image');
        ...
        {
            array_push($reduce, 'fana_photo_reviews_thumbnail_image');
            return $reduce;
        }
        ...
        public function mobile_add_add_to_cart_button_content()
        {
            ...
            if (fana_get_mobile_form_cart_style() === 'default') {
                return;
            }
        ...
        public function mobile_add_btn_after_add_to_cart_form()
        {
            ...
            $class = '';
            if (fana_tbay_get_config('enable_buy_now', true)) {
                $class .= ' has-buy-now';
            } ?>
            <div id="mobile-close-infor-wrapper"></div>
            <div class="mobile-btn-cart-click <?php echo esc_attr($class); ?>">
                <div id="tbay-click-addtocart"><?php esc_html_e('Add to cart', 'fana') ?></div>
                <?php if (fana_tbay_get_config('enable_buy_now', true)) : ?>
                <div id="tbay-click-buy-now"><?php esc_html_e('Buy Now', 'fana') ?></div>
                <?php endif; ?>
            </div>
            <?php
        }
        ...
        public function mobile_add_before_add_to_cart_form()
        {
            ...
            foreach ($attributes as $key => $value) {
                ...
                if (isset($selected_attributes[$key]) && !empty($selected_attributes[$key])) {
                    ...
                    $default = esc_html__('Choose an option ', 'fana');
                }
        ...
        public static function custom_field_detail_product() {
            ...
            $btn_ajax_value = '0';
            if ( 'yes' !== get_option('woocommerce_cart_redirect_after_add') && 'yes' === get_option('woocommerce_enable_ajax_add_to_cart') && fana_tbay_get_config('enable_ajax_single_add_to_cart', false) ) {
                $btn_ajax_value = '1';
            } 
               
            echo '<div class="fana-custom-fields d-none">';
            echo '<input type="hidden" name="fana-enable-addtocart-ajax" value="' . esc_attr($btn_ajax_value) . '" />';
...
if (!function_exists('fana_single_wooCommerce')) {
    function fana_single_wooCommerce()
    {
        return Fana_Single_WooCommerce::getInstance();
    }
    fana_single_wooCommerce();
}