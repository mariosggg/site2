...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Widget_Image')) {
    exit; // Exit if accessed directly.
}

use Elementor\Controls_Manager;

class Fana_Element_Site_Logo extends Fana_Elementor_Widget_Image
{
    public function get_name()
    {
        // `theme` prefix is to avoid conflicts with a dynamic-tag with same name.
        return 'fana-site-logo';
    }

    public function get_title()
    {
        return esc_html__('Fana Site Logo', 'fana');
    }
        ...
        $this->update_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'home' => esc_html__('Home Page', 'fana'),
                    'custom' => esc_html__('Custom URL', 'fana'),
                ],
            ]
        );
    ...
    {
        $logo_image = FANA_IMAGES . '/logo-default.svg';
...
$widgets_manager->register(new Fana_Element_Site_Logo());
