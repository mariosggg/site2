...
if ( ! defined( 'ABSPATH' ) || function_exists('Fana_Elementor_Search_Canvas') ) {
...
class Fana_Elementor_Search_Canvas extends Fana_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Fana Search Canvas', 'fana');
    }
    ...
    protected function _register_form_canvas() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Search for products...','fana'),
            ]
        );
        $this->add_control(
            'vali_input_search',
    ...
    protected function register_style_search_canvas() {
        ...
        $this->add_control(
            'padding_search',
            [
                'label'     => esc_html__('Padding Icon Search', 'fana'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors'  => [
                    '{{WRAPPER}} .btn-search-icon > i,
                                ...
                                <div class="button-group input-group-addon">
                                    ...
                                    <?php if ( $enable_categories_search === 'yes' ): ?>
                                        <div class="select-category input-group-addon">
                                            <span class="category-title"><?php esc_html_e( 'Search in:', 'fana' ) ?></span>
...
$widgets_manager->register(new Fana_Elementor_Search_Canvas());
