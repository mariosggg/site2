...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Canvas_Menu_Template')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Canvas_Menu_Template extends Fana_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Canvas Menu Template', 'fana');
    }
    ...
    {
        return [ 'fana-elements', 'fana-header'];
    }
    ...
    protected function register_controls()
    {
        ...
        if (empty($templates)) {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no templates in your site.</strong><br>Go to the <a href="%s" target="_blank">Templates screen</a> to create one.', 'fana'), admin_url('edit.php?post_type=elementor_library&tabs_group=library')),
                ]
            );
        ...
        $this->add_responsive_control(
            'canvas_menu_align',
            [
                'label' => esc_html__('Content Align', 'fana'),
...
$widgets_manager->register(new Fana_Elementor_Canvas_Menu_Template());
