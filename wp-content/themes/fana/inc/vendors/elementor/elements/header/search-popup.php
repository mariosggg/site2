...
if ( ! defined( 'ABSPATH' ) || function_exists('Fana_Elementor_Search_Popup') ) {
...
class Fana_Elementor_Search_Popup extends Fana_Elementor_Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Fana Search Popup', 'fana');
    }
                ...
                <div id="sidebar-popup-search" class="sidebar-popup-search zoom-anim-dialog mfp-hide">
                    <div class="sidebar-content">
                        <div class="content-heading">
                            <h3 class="heading"><?php esc_html_e('Search', 'fana'); ?></h3>
...
$widgets_manager->register(new Fana_Elementor_Search_Popup());
