<?php
// if (! defined('ABSPATH') || function_exists('Fana_Elementor_Product_Recently_Viewed_Header')) {
...
class Fana_Elementor_Product_Recently_Viewed_Header extends Fana_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Fana Product Recently Viewed Header', 'fana');
    }
    ...
    private function register_control_header()
    {
        ...
        $this->add_control(
            ...
            [
                'label'              => esc_html__('Display Title', 'fana'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Recently Viewed', 'fana'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            'header_column',
            [
                'label'     => esc_html__('Columns and max item', 'fana'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 8,
                'separator'    => 'after',
    ...
    {
        $value = apply_filters('fana_admin_elementor_recently_viewed_header_columns', [
           4 => 4,
           5 => 5,
           6 => 6,
           7 => 7,
...
$widgets_manager->register(new Fana_Elementor_Product_Recently_Viewed_Header());
