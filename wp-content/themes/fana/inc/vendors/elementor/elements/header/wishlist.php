...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Wishlist')) {
...
class Fana_Elementor_Wishlist extends Fana_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Fana Wishlist', 'fana');
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'section_layout',
            [
                'label' => esc_html__('Wishlist', 'fana'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Wishlist', 'fana'),
                'condition' => [
        ...
        $this->add_control(
            'show_total_wishlist',
            [
                'label'              => esc_html__('Show Total', 'fana'),
                'type'               => Controls_Manager::SWITCHER,
                'default'            => 'yes',
            ]
        );
...
$widgets_manager->register(new Fana_Elementor_Wishlist());
