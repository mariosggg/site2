...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Account')) {
...
class Fana_Elementor_Account extends Fana_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Fana Account', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'show_text_account',
            [
                'label'              => esc_html__('Display Text Account', 'fana'),
        ...
        $this->add_control(
            'text_before',
            [
                'label'              => esc_html__('Text Before Login', 'fana'),
        ...
        $this->add_control(
            'text_after',
            [
                'label'              => esc_html__('Text After Login', 'fana'),
                'type'               => Controls_Manager::TEXT,
                'condition'          => [
                    'show_text_account' => 'yes'
                ]        
        ...
        $this->add_control(
            'show_sub_account',
            [
                'label'              => esc_html__('Display Sub Menu', 'fana'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                'sub_menu_account',
                [
                    'label'        => esc_html__('Choose Menu', 'fana'),
        ...
        $this->add_control(
            'show_popup_login',
            [
                'label'              => esc_html__('Display Popup Login', 'fana'),
                'type'               => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
    ...
    protected function register_section_style_icon()
    {
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Padding Icon Account', 'fana'),
    ...
    public function check_login($show_text_account,$text_after,$text_before)
    {
        if (is_user_logged_in()) {
            ...
            if(!empty($text_before)) {
                ...
                $name = esc_html__('Login/Register', 'fana');
            }
...
$widgets_manager->register(new Fana_Elementor_Account());
