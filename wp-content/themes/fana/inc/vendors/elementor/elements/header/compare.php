...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Compare')) {
...
class Fana_Elementor_Compare extends Fana_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Fana Compare', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('My Compare', 'fana'),
                'condition' => [
...
$widgets_manager->register(new Fana_Elementor_Compare());
