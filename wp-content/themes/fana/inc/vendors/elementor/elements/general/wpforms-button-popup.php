...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_WPForms_Button_Popup')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_WPForms_Button_Popup extends Fana_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana WPForms Button Popup', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        if( empty( $forms ) ) {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no forms in your site.</strong><br>Go to the <a href="%s" target="_blank">Forms screen</a> to create one.', 'fana'), admin_url('admin.php?page=wpforms-overview')),
                    'separator'       => 'after',
            ...
            $this->add_control(
                'form_id',
                [
                    'label' => esc_html__('Wpforms Select', 'fana'),
			...
			[
				...
				'raw'             => sprintf(
					wp_kses( /* translators: %s - WPForms documentation link. */
						__( '<b>Heads up!</b> Don\'t forget to test your form. <a href="%s" target="_blank" rel="noopener noreferrer">Check out our complete guide!</a>', 'fana' ),
						[
							'b'  => [],
							'br' => [],
							'a'  => [
		...
		$this->start_controls_section(
			'section_display',
			[
				'label'     => esc_html__( 'Display Options', 'fana' ),
		...
		$this->add_control(
			'display_form_name',
			[
				'label'        => esc_html__( 'Form Name', 'fana' ),
		...
		$this->add_control(
			...
			[
				'label'        => esc_html__( 'Form Description', 'fana' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'fana' ),
				'label_off'    => esc_html__( 'Hide', 'fana' ),
				'separator'    => 'after',
    ...
    public function get_forms() {
        ...
        if ( empty( $forms_list ) ) {
            ...
            if ( ! empty( $forms ) ) {
                $forms_list[0] = esc_html__( 'Select a form', 'fana' );
...
$widgets_manager->register(new Fana_Elementor_WPForms_Button_Popup());