...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Newsletter')) {
...
class Fana_Elementor_Newsletter extends Fana_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana newsletter', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'form_style',
            [
                'label'        => esc_html__('Form Style Block', 'fana'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Alignment Form Style', 'fana'),
        ...
        $this->add_responsive_control(
            'width_input',
            [
                'label'      => esc_html__('Input Width', 'fana'),
        ...
        $this->add_control(
            'text_hide',
            [
                'label'        => esc_html__('Hide Text', 'fana'),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__('Off', 'fana'),
                'label_on'     => esc_html__('On', 'fana'),
                'default'      => '',
        ...
        $this->add_control(
            'icon_hide',
            [
                'label'        => esc_html__('Hide Icon', 'fana'),
                'type'         => Controls_Manager::SWITCHER,
                'label_off'    => esc_html__('Off', 'fana'),
                'label_on'     => esc_html__('On', 'fana'),
                'default'      => '',
        ...
        $this->add_responsive_control(
            'icon_margin',
            [
                'label'      => esc_html__('Margin Icon', 'fana'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'     => esc_html__('Button text typography', 'fana'),
        ...
        $this->add_responsive_control(
            'width_button',
            [
                'label'      => esc_html__('Buton width', 'fana'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'placeholder_color',
            [
                'label'     => esc_html__('Placeholder Color', 'fana'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_color_focus',
            [
                'label'     => esc_html__('Button Color', 'fana'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Fana_Elementor_Newsletter());
