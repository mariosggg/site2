...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Brands')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Brands extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Brands', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'brands',
            [
                'label' => esc_html__('Brand Items', 'fana'),
...
$widgets_manager->register(new Fana_Elementor_Brands());
