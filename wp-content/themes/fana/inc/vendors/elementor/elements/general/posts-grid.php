...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Posts_Grid')) {
...
class Fana_Elementor_Posts_Grid extends Fana_Elementor_Carousel_Base
{
    ...
    {
        return esc_html__('Fana Posts Grid', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of posts', 'fana'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Number of posts to show ( -1 = all )', 'fana'),
                'default' => 6,
                'min'  => -1
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'fana'),
                    'post_title' => esc_html__('Title', 'fana'),
    ...
    protected function register_title_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_on' => esc_html__('Show', 'fana'),
                'label_off' => esc_html__('Hide', 'fana'),
                'default' => 'yes',
    ...
    protected function register_category_controls()
    {
        $this->add_control(
            'advanced_category',
            [
                'label' => esc_html__('Category', 'fana'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    protected function register_excerpt_controls()
    {
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label' => esc_html__('Excerpt Length', 'fana'),
                'type' => Controls_Manager::NUMBER,
    ...
    protected function register_read_more_controls()
    {
        $this->add_control(
            'advanced_read_more',
            [
                'label' => esc_html__('Read More', 'fana'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'read_more_text',
            [
                'label' => esc_html__('Read More Text', 'fana'),
    ...
    protected function register_meta_controls()
    {
        ...
        $this->add_control(
            'show_comments',
            [
                'label' => esc_html__('Comments', 'fana'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'fana'),
                'label_off' => esc_html__('Hide', 'fana'),
                'default' => 'no',
        ...
        $this->add_control(
            'show_comments_text',
            [
                'label' => esc_html__('Comments Text', 'fana'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'fana'),
                'label_off' => esc_html__('Hide', 'fana'),
                'default' => 'no',
    ...
    {
        $folderes = glob(FANA_PAGE_TEMPLATES. '/posts/item-*');
...
$widgets_manager->register(new Fana_Elementor_Posts_Grid());
