...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Gallery')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Gallery extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Gallery', 'fana');
    }

    public function get_script_depends()
    {
        return [ 'slick', 'fana-custom-slick', 'photoswipe', 'photoswipe-ui-default' ];
    } 
    ...
    protected function style_gallery()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Wrapper Gallery', 'fana'),
        ...
        $this->add_control(
            'heading_text_style',
            [
                'label' => esc_html__('Text on photo', 'fana'),
                'type' => Controls_Manager::HEADING,
                'separator'   => 'before',
            ]
        );
...
$widgets_manager->register(new Fana_Elementor_Gallery());