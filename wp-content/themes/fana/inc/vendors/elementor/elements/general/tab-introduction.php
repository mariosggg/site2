...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Tab_Introduction')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Tab_Introduction extends Fana_Elementor_Widget_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Tab Introduction', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__('Tab Items', 'fana'),
    ...
    private function register_set_tabs_default()
    {
        $defaults = [
            [
                'tab_name' => esc_html__('Tab name 1', 'fana'),
                'tab_content' => esc_html__('Lorem ipsum dolor sit amet, in mel unum delicatissimi conclusionemque', 'fana'),
            ],
            [
                'tab_name' => esc_html__('Tab name 2', 'fana'),
                'tab_content' => esc_html__('Lorem ipsum dolor sit amet, in mel unum delicatissimi conclusionemque 2', 'fana'),
            ],
            [
                'tab_name' => esc_html__('Tab name 3', 'fana'),
                'tab_content' => esc_html__('Lorem ipsum dolor sit amet, in mel unum delicatissimi conclusionemque 3', 'fana'),
            ],
        ];
...
$widgets_manager->register(new Fana_Elementor_Tab_Introduction());