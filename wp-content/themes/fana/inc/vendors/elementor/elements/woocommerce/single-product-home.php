...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Products')) {
...
class Fana_Elementor_Single_Product_Home extends Fana_Elementor_Widget_Base
{
    ...
    {
        return esc_html__('Fana Single Product Home Page', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        if( fana_elementor_pro_activated() ) {
            $this->add_control(
                'product_id',
                [
                    'label' => esc_html__( 'Product ID', 'fana' ),
        ...
        $this->add_control(
            'show_image',
            [
                'label'     => esc_html__('Show Image', 'fana'),
        ...
        $this->add_control(
            'show_title',
            [
                'label'     => esc_html__('Show Title', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->add_control(
            'show_price',
            [
                'label'     => esc_html__('Show Price', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->add_control(
            'show_rating',
            [
                'label'     => esc_html__('Show Rating', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Short Description', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->add_control(
            'show_form_cart',
            [
                'label'     => esc_html__('Show Form Cart', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'yes'
            ]
        );
        ...
        $this->add_control(
            'show_meta',
            [
                'label'     => esc_html__('Show Product Meta', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        );
    ...
    private function register_section_style_content() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Short Description', 'fana'),
                'separator'    => 'before',
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Form Cart', 'fana'),
                'separator'    => 'before',
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Product Meta', 'fana'),
                'separator'    => 'before',
                'type' => Controls_Manager::HEADING,
            ]
        );
    ...
    private function the_add_to_cart( $product_id ) {
        ...
        remove_action('woocommerce_after_add_to_cart_button', array( Fana_Single_WooCommerce::getInstance(), 'product_group_buttons'), 20);

        woocommerce_template_single_add_to_cart();

        add_action('woocommerce_after_add_to_cart_button', array( Fana_Single_WooCommerce::getInstance(), 'product_group_buttons'), 20);
...
$widgets_manager->register(new Fana_Elementor_Single_Product_Home());
