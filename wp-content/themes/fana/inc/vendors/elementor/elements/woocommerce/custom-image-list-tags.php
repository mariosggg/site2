...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Custom_Image_List_Tags')) {
...
class Fana_Elementor_Custom_Image_List_Tags extends Fana_Elementor_Carousel_Base
{
    ...
    {
        return esc_html__('Fana Custom Image List Tags', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        if (is_array($tag_slug) && count($tag_slug)) {
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no tags in your site.</strong><br>Go to the <a href="%s" target="_blank">Tags screen</a> to create one.', 'fana'), admin_url('edit-tags.php?taxonomy=product_tag&post_type=product')),
                    'separator'       => 'after',
        ...
        $repeater->add_control(
            'tag_style',
            [
                'label' => esc_html__('Choose Style', 'fana'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'images' => [
                        'title' => esc_html__('Image', 'fana'),
                        'icon' => 'fa fa-image',
                    ],
                    'icon' => [
                        'title' => esc_html__('Icon', 'fana'),
                        'icon' => 'fa fa-info',
                    ],
                ],
                'default' => 'images',
        ...
        $repeater->add_control(
            'tag_add_link',
            [
                'label' => esc_html__('Add Custom Link', 'fana'),
        ...
        $this->add_control(
            'tags',
            [
                'label' => esc_html__('List Tags', 'fana'),
    ...
    protected function register_button()
    {
        $this->add_control(
            'show_before_text',
            [
                'label'     => esc_html__('Show Before Text', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'separator' => 'before',
        ...
        $this->add_control(
            'show_all',
            [
                'label'     => esc_html__('Button Show All', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            'show_count',
            [
                'label'     => esc_html__('Show Count', 'fana'),
                'description' => esc_html__('Display the product number of the tags', 'fana'),
                'type'      => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        );
    ...
    protected function register_design_content_controls()
    {
        ...
        $this->add_responsive_control(
            'align_content',
            [
                'label' => esc_html__('Alignment Tag Icon', 'fana'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
        ...
        $this->add_responsive_control(
            'align_content_img',
            [
                'label' => esc_html__('Alignment Tag Image', 'fana'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__('Left', 'fana'),
        ...
        $this->add_responsive_control(
            'item_padding',
            [
                'label' => esc_html__('Item Padding', 'fana'),
        ...
        $this->add_responsive_control(
            'icon_item_padding',
            [
                'label' => esc_html__('Icon Item Padding', 'fana'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px' ],
                'selectors' => [
    ...
    public function render_item($item)
    {
        ...
        $tag_name       = $tag->name;
        $tag_count      = fana_get_product_count_of_tags($tag);
...
$widgets_manager->register(new Fana_Elementor_Custom_Image_List_Tags());
