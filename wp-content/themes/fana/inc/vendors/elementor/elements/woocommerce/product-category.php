...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Product_Category')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Product_Category extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Product Category', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('Product Category', 'fana'),
            ]
        );
        $this->add_control(
            'limit',
...
$widgets_manager->register(new Fana_Elementor_Product_Category());
