...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Custom_Image_List_Categories')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Custom_Image_List_Categories extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Custom Image List Categories', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('Custom Image List Categories', 'fana'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('List Categories Items', 'fana'),
        ...
        $this->add_control(
            'style_type',
            [
                'label'     => esc_html__('Style Type', 'fana'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'v1',
                'options'   => [
                    'v1'      => esc_html__('Style 1', 'fana'),
                    'v2'  => esc_html__('Style 2', 'fana'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Count Category', 'fana'),
        ...
        $this->add_control(
            'text_show_all',
            [
                'label'     => esc_html__('Text Show All', 'fana'),
        ...
        $this->add_control(
            'icon_show_all',
            [
                'label'     => esc_html__('Icon Show All', 'fana'),
    ...
    private function register_list_category_repeater()
    {
        ...
        $repeater->add_control(
            'category',
            [
                'label' => esc_html__('Choose category', 'fana'),
                'type' => Controls_Manager::SELECT,
        ...
        $repeater->add_control(
            'type',
            [
                'label' => esc_html__('Type Custom', 'fana'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'image' => [
        ...
        $repeater->add_control(
            'display_custom',
            [
                'label' => esc_html__('Show Custom Link', 'fana'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no'
            ]
        );
        ...
        $repeater->add_control(
            'custom_link',
            [
                'label' => esc_html__('Custom Link', 'fana'),
    ...
    private function register_section_styles_custom_image_list_categories()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Categories Item ', 'fana'),
    ...
    private function resgiter_heading_style_content()
    {
        $this->add_control(
            ...
            [
                'label' => esc_html__('Content Item', 'fana'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hover Background', 'fana'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    private function resgiter_heading_style_count() 
    {
        $this->add_control(
            ...
            [
                'label' => esc_html__('Count item', 'fana'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    public function render_item_content($item, $attribute, $display_count_category)
    {
        ...
        <?php $this->render_item_type($type, $url_category, $type_icon, $type_image); ?>
            <div class="content">
                ...
                <?php if ($display_count_category === 'yes' && $settings['style_type'] === 'v1') {
                        ?><span class="count-item">
                    <?php echo trim($count).' '.esc_html__('products', 'fana'); ?>
                </span><?php
                    } ?>
...
$widgets_manager->register(new Fana_Elementor_Custom_Image_List_Categories());