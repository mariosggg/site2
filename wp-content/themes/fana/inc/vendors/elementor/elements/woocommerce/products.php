...
class Fana_Elementor_Products extends Fana_Elementor_Carousel_Base
{
    ...
    {
        return esc_html__('Fana Products', 'fana');
    }
...
$widgets_manager->register(new Fana_Elementor_Products());
