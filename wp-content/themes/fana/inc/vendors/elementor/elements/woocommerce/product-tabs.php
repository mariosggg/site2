...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_Product_Tabs')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_Product_Tabs extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana Product Tabs', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('Product Tabs', 'fana'),
            ]
        );
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of products ( -1 = all )', 'fana'),
        ...
        $this->add_control(
            'ajax_tabs',
            [
                'label' => esc_html__( 'Ajax Product Tabs', 'fana' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'description' => esc_html__( 'Show/hidden Ajax Product Tabs', 'fana' ), 
            ]
        );
    ...
    public function register_controls_product_tabs()
    {
        ...
        $repeater->add_control(
            'product_tabs',
            [
                'label' => esc_html__('Show Tabs', 'fana'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'list_product_tabs',
            [
                'label' => esc_html__('Tab Item', 'fana'),
...
$widgets_manager->register(new Fana_Elementor_Product_Tabs());
