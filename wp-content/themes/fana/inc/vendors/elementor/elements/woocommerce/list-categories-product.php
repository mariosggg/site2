...
if (! defined('ABSPATH') || function_exists('Fana_Elementor_List_Categories_Product')) {
 ...
 * @since 1.0.0
 */
class Fana_Elementor_List_Categories_Product extends Fana_Elementor_Carousel_Base
{
    /**
     * Get widget name.
     *
    ...
    {
        return esc_html__('Fana List Categories Product', 'fana');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'section_general',
            [
                'label' => esc_html__('List Categories Product', 'fana'),
            ]
        );
        $this->add_control(
            'limit',
            [
                'label' => esc_html__('Number of categories', 'fana'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Number of categories to show ( -1 = all )', 'fana'),
                'min'  => -1,
                'default' => 6,
            ]
        );
    ...
    protected function register_button()
    {
        $this->add_control(
            ...
            [
                ...
                'default' => 'no',
                'options' => [
                    'no' => esc_html__('No', 'fana'),
                    'show' => esc_html__('Show All', 'fana')
                ]
            ]
        );
        $this->add_control(
                            ...
                            if ( is_object($obj_cat) ) :
                                ...
                                echo '<div class="cat-content">'; ?>
                                        ...
                                        <?php
                                            if ($show_count === 'yes') {
                                                ?>
                                                <span class="count-item"><?php echo trim($count).' '.esc_html__('products', 'fana'); ?></span>
                                                <?php
                                            } ?>
...
$widgets_manager->register(new Fana_Elementor_List_Categories_Product());
