...
class Tbay_Widget_Popup_Newsletter extends Tbay_Widget
{
    ...
    {
        parent::__construct(
            'fana_popup_newsletter',
            esc_html__('Fana Popup Newsletter', 'fana'),
            array( 'description' => esc_html__('Show Popup Newsletter', 'fana'), )
        );
    ...
    public function form($instance)
    {
        $list_socials = apply_filters(
            'fana_popup_newsletter_list_socials',array(
                'facebook'      => 'Facebook',
                'twitter'       => 'Twitter',
        ...
        $defaults = array(
            ...
            'message' => esc_html__('Message Close', 'fana'),
            'image' => '',
            'socials' => array());
        $instance = wp_parse_args((array) $instance, $defaults);
        // Widget admin form?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'fana'); ?></strong></label>
            <input type="text" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($instance['title']) ; ?>" class="widefat" />
        </p>
                
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:', 'fana'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('message')); ?>"><?php esc_html_e('Message Close:', 'fana'); ?></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image:', 'fana'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('socials')); ?>"><?php esc_html_e('Select socials:', 'fana'); ?></label>
            <br>
        <?php
        ...
        $link = (isset($instance['socials'][$key]['page_url'])) ? $instance['socials'][$key]['page_url']: ''; ?>
                ...
                <input class="checkbox" type="checkbox" <?php checked($checked, 1); ?> id="<?php echo esc_attr($key); ?>"
                    ...
                    <label for="<?php echo esc_attr($this->get_field_name('socials')); ?>[<?php echo esc_attr($key); ?>][status]">
                        <?php echo esc_html__('Show ', 'fana').esc_html($value); ?>
                    </label>
                ...
                <p style="display: <?php echo trim($check_value); ?>" id="<?php echo esc_attr($this->get_field_id($key)); ?>" class="text_url <?php echo esc_attr($key); ?>">
                    <label for="<?php echo esc_attr($this->get_field_name('socials')); ?>[<?php echo esc_attr($key); ?>][page_url]">
                        <?php echo esc_html($value).' '.esc_html__('Page URL:', 'fana').' '; ?>
                    </label>
