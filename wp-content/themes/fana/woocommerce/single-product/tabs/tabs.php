...
$tabs_layout   =  apply_filters('fana_woo_tabs_style_single_product', 10, 2);
if (wp_is_mobile() && fana_tbay_get_config('enable_tabs_mobile', false)) {
...
if ($tabs_layout !== 'fulltext') {
	...
	add_filter('fana_woocommerce_product_more_product_heading', '__return_empty_string', 10, 1);
}
