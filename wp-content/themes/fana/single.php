...
<section id="main-container" class="main-content <?php echo esc_attr(apply_filters('fana_tbay_blog_content_class', 'container')); ?>">
				...
				<div id="content" class="site-content single-post" role="main">
					<?php
                        ...
                        while (have_posts()) : the_post();
                            ...
                            if (fana_tbay_get_config('show_blog_related', false)): ?>
