...
if (isset(woof()->settings['by_backorder']) AND woof()->settings['by_backorder']['show']) {
    ?>
    <div data-css-class="woof_checkbox_onbackorder_container" class="woof_checkbox_onbackorder_container woof_container woof_container_backorder <?php echo WOOF_HELPER::generate_container_css_classes('by_backorder') ?>">
        ...
        <div class="woof_container_inner">
            ...
            if (isset(woof()->settings['by_backorder']['view']) && woof()->settings['by_backorder']['view'] === 'switcher') {
                ...
                <div class="switcher23-container">
                    ...
                    <input type="checkbox" class="woof_checkbox_onbackorder_as_switcher switcher23" id="<?php echo $unique_id ?>" name="backorder" value="0" <?php checked('onbackorder', woof()->is_isset_in_request_data('backorder') ? 'onbackorder' : '', true) ?> />
